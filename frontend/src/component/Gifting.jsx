  ...
  return (
        <>
             <div className="sweet-section background-rgb(241, 221, 168)" data-aos="fade-up" data-aos-delay="300">
               <h1 className='text-center py-4' style={{ fontFamily: "-moz-initial" }}>Gifting</h1>
            ...
            <div className="container" data-aos="fade-up" data-aos-delay="300">
              <div className="row sweets-img">
                ...
                <div className="col-lg-2 col-sm-6">
                  <img src='https://res.cloudinary.com/dvo3apbag/image/upload/v1744129916/Tea_Time_cuzbbg.webp'/>
  ...
  <div className="row">
      {products.map((product)=>(
        ...
        <div className="card h-100 text-center p-3 position-relative">
          ...
          <img src={product.image} className="card-img-top w-100 " alt={product.name}  style={{ height: '250px', objectFit: 'cover' }} /></Link>
